...
**Review Status**:
The item's lightweight attention state, such as needing review because metadata extraction was incomplete, import was basic, manual fallback was used, duplicate candidates exist, or AI suggestions need acceptance. Review status helps the user find items that were captured successfully but still need human cleanup.
