...
- `gruenes-gewolbe-desktop`: desktop-shell-facing module with a Tauri config, static workbench UI scaffold, explicit active-vault handling, remembered vault roots, and a Tauri-facing command adapter with frontend-ready view models.
