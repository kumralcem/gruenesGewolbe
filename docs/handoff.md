...
- Repeated identical image previews are removed from model context; public link/image candidates are bounded; local image research gets four browse/fetch reads. Completed captures no longer need another paid completion to announce success. Full originals remain intact. These bounds are not general long-document compaction.
