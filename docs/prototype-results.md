# Historical prototype findings — 2026-09-10

> This records the state before the repository cleanup and browser extension. See [current validation](validation.md) and [setup](../README.md) for the current implementation. References below to the old application or deferred repository replacement describe that earlier run.
